  ...
  return (
    <section className="prose prose-invert mx-auto max-w-[720px] px-4 py-16 prose-headings:font-medium">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to CTF Arena, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to CTF Arena.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to CTF Arena, accessible from{" "}
            <a
              href="https://www.ctf-arena.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.ctf-arena.com
            </a>{" "}
      ...
      <ul>
        <li>
          By email:{" "}
          <a href={`mailto:${config.app.sourceEmailAddress.support}`}>
            {config.app.sourceEmailAddress.support}
          </a>
        </li>
      </ul>
    </section>
