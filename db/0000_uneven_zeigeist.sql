DO $$ BEGIN
 CREATE TYPE "public"."team_request_status" AS ENUM('queued', 'delivered', 'accepted', 'rejected');
EXCEPTION
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "contests_submissions" ADD CONSTRAINT "contests_submissions_submitted_by_team_teams_id_fk" FOREIGN KEY ("submitted_by_team") REFERENCES "public"."teams"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "contests_submissions" ADD CONSTRAINT "contests_submissions_submitted_by_user_users_id_fk" FOREIGN KEY ("submitted_by_user") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "team_members_team_index" ON "team_members" ("team_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "team_members_user_team_index" ON "team_members" ("user_id","team_id","left_at");